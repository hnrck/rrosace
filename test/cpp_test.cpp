...
auto main() -> int {
  ...
  try {
    ...
    // Filters
    {
      ...
      RROSACE::PitchRateFilter pitchRateFilter =
          RROSACE::PitchRateFilter(q, q_f);
    ...
    // FCU
    {
      ...
      std::cout << "vz_c: " << RROSACE::VZ_EQ << " -> " << vz_c_out
                << std::endl;
      std::cout << "va_c: " << RROSACE::VA_EQ << " -> " << va_c_out
                << std::endl;
    }
    ...
    // FCCs
    {
      ...
      RROSACE::FlightControlComputer flightControlComputerCommand =
          RROSACE::FlightControlComputer(mode, h, vz, va, q, az, h_c, vz_c,
                                         va_c, delta_e_c, delta_th_c);
      ...
      flightControlComputerCommand.step();
      flightControlComputerMonitor.step();
